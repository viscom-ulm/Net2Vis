...
class Patterns extends React.Component {
  ...
  render() {
    return(// Editor with Syntax highlighting
      <defs id='main_defs'>
        <pattern id="muster1" x="0" y="0" width="8" height="8" patternUnits="userSpaceOnUse">
        ...
        <pattern id="muster6" x="0" y="0" width="10" height="10" patternUnits="userSpaceOnUse">
          <path d='M-1,1 l2,-2 M0,10 l10,-10 M9,11 l2,-2' stroke='black' strokeWidth='1'/>
        </pattern>
        <pattern id="muster7" x="0" y="0" width="10" height="10" patternUnits="userSpaceOnUse">
          <path d='M-1,1 l2,-2 M0,10 l10,-10 M9,11 l2,-2' stroke='black' strokeWidth='8'/>
        </pattern>
        <pattern id="muster8" x="0" y="0" width="10" height="10" patternUnits="userSpaceOnUse">
          <path d='M-1,1 l2,-2 M0,10 l10,-10 M9,11 l2,-2' stroke='black' strokeWidth='3'/>
        </pattern>
        <pattern id="muster9" x="0" y="0" width="10" height="10" patternUnits="userSpaceOnUse">
          <rect x='0' y='0' width='10' height='1'/>
        </pattern>
        <pattern id="muster10" x="0" y="0" width="10" height="10" patternUnits="userSpaceOnUse">
          <rect x='0' y='0' width='10' height='9'/>
        </pattern>
        <pattern id="muster11" x="0" y="0" width="10" height="10" patternUnits="userSpaceOnUse">
          <rect x='0' y='0' width='1' height='10'/>
        </pattern>
        <pattern id="muster12" x="0" y="0" width="10" height="10" patternUnits="userSpaceOnUse">
