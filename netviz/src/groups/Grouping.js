...
function addInputsToLayer(selection, network, i) {
  ...
  var inputs = network.layers[common.getLayerByID(selection[i], network.layers)].properties.input; // Get all inputs for the current Layer
...
function addOutputsToLayer(selection, network, i) {
  ...
  var outputs = network.layers[common.getLayerByID(selection[i], network.layers)].properties.output; // Get all outputs for the current Layer
