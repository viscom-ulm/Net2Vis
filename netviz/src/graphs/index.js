...
export function buildGraphFromNetwork(network, layer_extreme_dimensions, preferences) {
  ...
  graph.setGraph({ranker: 'longest-path', rankdir: 'LR', ranksep: (preferences.layers_spacing_horizontal.value + preferences.stroke_width.value), nodesep: preferences.layers_spacing_vertical.value}); // Set Graph Properties
