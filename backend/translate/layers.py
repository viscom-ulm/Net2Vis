...
class Conv2D(Layer):
  ...
  def calculate_dimensions(self, input_dim):
    ...
    self.dimensions = {
      'in': input_dim[0]['out'],
      'out': [calculate_next_layer(p[0], tupelize(self.properties['strides'])[0], input_dim[0]['out'][0], self.kernel_size[0]), calculate_next_layer(p[1], tupelize(self.properties['strides'])[1], input_dim[0]['out'][1], self.kernel_size[1]), self.filters]
    }
...
class MaxPool2D(Layer):
  ...
  def calculate_dimensions(self, input_dim):
    ...
    self.dimensions = {
      'in': input_dim[0]['out'],
      'out': [calculate_next_layer(p[0], str[0], input_dim[0]['out'][0], tupelize(self.properties['pool_size'])[0]), calculate_next_layer(p[1], str[1], input_dim[0]['out'][1], tupelize(self.properties['pool_size'])[1]), input_dim[0]['out'][2]]
    }
